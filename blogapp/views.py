...
from django.contrib.auth import logout # Nouvel import 
from django.contrib.auth.forms import UserCreationForm 
from django.contrib.auth.forms import AuthenticationForm # Nouvel import 
from django.contrib.auth import login # Pour connecter l'utilisateur directement après inscription 
from django.shortcuts import render, redirect, get_object_or_404 
from django.contrib.auth.decorators import login_required # Pour protéger les vues 
from .models import Article 
from .forms import ArticleForm # Importer notre nouveau formulaire
from .models import Article, Commentaire # Ajoutez Commentaire 
from .forms import ArticleForm, CommentaireForm # Ajoutez CommentaireForm 
...
def accueil_view(request): 
 articles = Article.objects.all().order_by('-date_creation') # Récupère tous les articles, triés par date de création décroissante 
 context = { 
   'articles': articles 
 } 
